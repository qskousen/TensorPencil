...
pub const entries = [_]Entry{
    ...
    .{ .name = "gemv_q2_k", .wg = row_wg, .kind = .rows },
    .{ .name = "gemv_q2_k_q8", .wg = row_wg, .kind = .rows },
    .{ .name = "gemv_q3_k", .wg = row_wg, .kind = .rows },
    .{ .name = "gemv_q3_k_q8", .wg = row_wg, .kind = .rows },
    .{ .name = "gemv_iq2_xxs", .wg = row_wg, .kind = .rows },
    .{ .name = "gemv_iq2_xxs_q8", .wg = row_wg, .kind = .rows },
    .{ .name = "gemv_iq2_xs", .wg = row_wg, .kind = .rows },
    .{ .name = "gemv_iq2_xs_q8", .wg = row_wg, .kind = .rows },
    .{ .name = "gemv_iq3_xxs", .wg = row_wg, .kind = .rows },
    .{ .name = "gemv_iq3_xxs_q8", .wg = row_wg, .kind = .rows },
    .{ .name = "gemv_iq3_s", .wg = row_wg, .kind = .rows },
    .{ .name = "gemv_iq3_s_q8", .wg = row_wg, .kind = .rows },
};
